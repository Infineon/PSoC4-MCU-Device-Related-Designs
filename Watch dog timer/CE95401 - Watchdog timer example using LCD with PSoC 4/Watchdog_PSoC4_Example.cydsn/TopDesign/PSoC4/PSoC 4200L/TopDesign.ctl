...
-- === RGB LED ===
attribute port_location of LED_Reset(0) : label is "PORT(5,2)"; -- RED LED
attribute port_location of LED_WdtInt(0) : label is "PORT(5,3)"; -- GREEN LED
attribute port_location of LED_WdtReset(0) : label is "PORT(5,4)"; -- BLUE LED
